...
/**
 * `not-found.tsx` for the M10 Portfolio Page (Page Spec §11 — `not-found`).
 * Triggered when `getImportedRepo(owner, repo)` returns `null` — the
 * repository hasn't been imported. Offers a direct link back to `/import`
 * (M11 reuse, ADR 0009).
 */
          ...
          <section className="status-region" role="alert">
            <div className="status-card" data-error="true">
              ...
              <p className="status-body">
                The portfolio page reads cached learning memory for an
                imported repository snapshot. Import the repository first,
                then come back here.
              </p>
