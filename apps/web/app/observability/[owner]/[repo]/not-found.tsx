...
/**
 * `not-found.tsx` for the M13 Observability Page (Page Spec §11 — `not-found`).
 * Triggered when `getObservability(owner, repo)` returns `kind: "no-snapshot"`
 * — the repository hasn't been imported. Offers a direct link back to `/import`
 * (M11 reuse).
 */
          ...
          <section className="status-region" role="alert">
            <div className="status-card" data-error="true">
              ...
              <p className="status-body">
                The observability view reads a local snapshot of an imported
