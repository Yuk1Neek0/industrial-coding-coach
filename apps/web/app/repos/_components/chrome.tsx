...
// Badge mirror the M5 / M3 / M8 page chrome so the whole app reads as one
// product.
...
/** Top app navigation bar — shared shape with the M2 / M3 / M5 / M8 chrome. */
  ...
  return (
    <nav className="nav" aria-label="Primary">
      <div className="nav-brand">
        ...
        <span>Coach</span>
        <span className="mark-label">v0.5 · m7</span>
      </div>
