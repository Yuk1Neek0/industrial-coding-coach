...
// chrome (inline stroke SVGs, Badge, AiLabel) so the whole app reads as one
// product. The top app navigation bar is the shared component (task #256) —
// the chrome re-exports it so existing page imports keep working; challenge
